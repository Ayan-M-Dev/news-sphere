      ...
      <div className="flex-1 ml-64">
        ...
        <main className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Scraped Content</h2>
              <p className="text-gray-600 dark:text-gray-400 mt-1">View and manage content scraped from your sources</p>
            </div>
            ...
            <Card>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">892</p>
                </div>
            ...
            <Card>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">355</p>
                </div>
