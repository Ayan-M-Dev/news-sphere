        ...
        <div className="p-4 md:p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Create and manage your newsletter campaigns</p>
                </div>
                        ...
                        <TableBody>
                            {[
                                ...
                                <TableRow key={idx}>
                                    ...
                                    <TableCell className="text-muted-foreground">{campaign.lastRun}</TableCell>
                                    <TableCell>
