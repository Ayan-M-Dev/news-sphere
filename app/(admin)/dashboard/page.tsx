      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="mt-4 flex items-center text-sm">
              <span className="text-muted-foreground">Active translations</span>
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between p-4 rounded-lg bg-muted">
                  <div className="flex-1">
                    <p className="font-medium">Weekly AI Newsletter</p>
                    <p className="text-sm text-muted-foreground mt-1">Sent to 342 contacts</p>
                  </div>
